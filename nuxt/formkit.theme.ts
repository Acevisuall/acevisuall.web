...
const classes: Record<string, Record<string, boolean>> = {
  ...
  'family:dropdown__listbox': {
    ...
    'group-data-[overscroll]:border-black': true,
  },
  ...
  autocomplete__selectionWrapper: {
    ...
    'group-data-[multiple]:border-black': true,
  ...
  mask__input: {
    ...
    'group-data-[has-overlay]:!caret-black': true,
  },
  mask__overlay: {
    'text-black': true,
  },
  ...
  rating__ratingItem: {
    ...
    'focus-within:outline-black': true,
    'w-[1.5em]': true,
    'h-[1.5em]': true,
  },
  ...
  slider__chartBar: {
    ...
    'h-full': true,
    'bg-neutral-400': true,
    'data-[active=true]:bg-black': true,
  },
  ...
  togglebuttons__input: {
    ...
    'aria-[pressed=true]:bg-black': true,
    ...
    'group-data-[vertical=false]/options:group-first/option:aria-[pressed=true]:border-l-black': true,
    'group-data-[vertical=false]/options:group-last/option:aria-[pressed=true]:border-r-black': true,
    ...
    'group-data-[vertical=true]/options:group-first/option:aria-[pressed=true]:border-t-black': true,
    'group-data-[vertical=true]/options:group-last/option:aria-[pressed=true]:border-b-black': true,
  },
  transferlist__outer: {
    group: true,
    'flex-grow': true,
    ...
    'data-[disabled]:pointer-events-none': true,
    'max-w-none': true,
    '[&_.dnd-placeholder]:bg-black': true,
  ...
  'multi-step__tabs': {
    ...
    'group-data-[tab-style=tab]/wrapper:border-black': true,
  ...
  'multi-step__tab': {
    ...
    'group-data-[tab-style=progress]/wrapper:data-[valid=true]:data-[visited=true]:after:bg-black': true,
